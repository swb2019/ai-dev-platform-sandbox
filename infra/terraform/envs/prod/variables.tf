...
variable "gke_location" {
  description = "Optional override for the production GKE Autopilot location. Defaults to the region."
  type        = string
  default     = null
}

variable "artifact_registry_location" {
  description = "Optional override for the production Artifact Registry location. Defaults to the region."
  type        = string
  default     = null
}

variable "common_labels" {
  description = "Labels applied to all production resources."
  type        = map(string)
  default     = {}
}

variable "deletion_protection" {
  description = "Whether to enable deletion protection on production resources."
  type        = bool
  default     = true
}

variable "nat_logging" {
  description = "Enable Cloud NAT logging in production."
  type        = bool
  default     = true
}
