...
module "services" {
  ...
  repository_description = "Staging container images"
...
module "network" {
  ...
  network_description = "Staging core VPC"
...
module "wif" {
  ...
  pool_display_name     = "Staging GitHub WIF Pool"
  pool_description      = "GitHub OIDC federation for staging infrastructure"
  provider_id           = "${local.name_prefix}-gha"
  provider_display_name = "Staging GitHub OIDC"
  provider_description  = "GitHub Actions provider for staging"
  attribute_mapping = {
...
resource "google_service_account" "terraform" {
  ...
  display_name = "Staging Terraform Admin"
}

resource "google_service_account" "runtime" {
  account_id   = local.runtime_service_account_id
  display_name = "Staging Runtime"
}
